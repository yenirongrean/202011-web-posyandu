...
<body>
	...
	<div class="container">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "INSERT INTO imunisasi(id_imunisasi, idbalita, hb, bcg, dpt1, hb2, hb3, campak, status_imunisasi, status_berat_badan, status_tinggi_badan, status_lingkar_kepala)
				VALUES('$id_imunisasi', '$idbalita', '$hb', '$bcg', '$dpt1', '$hb2', '$hb3', '$campak', '$status_imunisasi', '$status_berat_badan', '$status_tinggi_badan', '$status_lingkar_kepala')") or die(mysqli_error($koneksi));
				if($sql){
		...
		<form action="create-imunisasi.php" method="post" autocomplete="off">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="id_imunisasi" class="form-control" required>
				</div>
			</div>
			<div class="form-group row">
